...
setup(
    name='pinventory-solar',

    version=find_version("pinventory_solar/__init__.py"),

    description='An plugin to pinventory for categorizing Raspberry Pi hosts',
    ...
    entry_points={
        'pinventory.transform.inventory': [
            'transform=pinventory_solar.inventory:transform'
        ],
        'pinventory.transform.hostsvars': [
            'transform=pinventory_solar.hostsvars:transform'
        ]
    },
)